...
public class NutrientListAdapter extends ArrayAdapter<String> implements Filterable{
	...
	public NutrientListAdapter(Context context, int textViewResourceId, ArrayList<Nutrient> nutrients) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		View v = inflater.inflate(R.layout.nutrient_list_item_wbuttons, parent, false);
			...
			protected FilterResults performFiltering(CharSequence prefix) {
	            ...
	            if (prefix == null || prefix.length() == 0) {
	                ...
	                final ArrayList<Nutrient> newItems = new ArrayList<Nutrient>(
	                        count);
	            	Log.v("mylog", prefixString + " " + count);
	                for (int i = 0; i < count; i++) {
	                	Log.v("mylog", "for");
	                	 final String item = items.get(i).name.toString();
	                     final String itemName = items.get(i).name.toString().toLowerCase();
