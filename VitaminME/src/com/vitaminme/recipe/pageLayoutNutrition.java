...
public class pageLayoutNutrition extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		TextView caloriesFromFat = (TextView) vg.findViewById(R.id.calories_from_fat);
		...
		if(recipe.getFatNutrient() != null){
			caloriesFromFat.setText("Calories from Fat " + (int)recipe.getFatNutrient().value*9);}
		else
...
//			Log.v("mytag", "measured height " + listItem.getMeasuredHeight());
			totalHeight += 46;
		}
